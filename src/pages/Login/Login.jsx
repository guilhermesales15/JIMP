...
export default function Login() {
  ...
  return (
    ...
    <StatusBar style="auto" />
      ...
      <TouchableOpacity style={styles.buttom} onPress={() => navigation.navigate('MapMenu')}> 
        <Text style={styles.buttomText}>Entrar</Text>
      </TouchableOpacity>


        <TouchableOpacity>
            <Text style={styles.cadastroTxt}  onPress={() => navigation.navigate('SignUp')} >
                Não possuí uma conta? Clique aqui e cadastre-se
            </Text>
        </TouchableOpacity>
